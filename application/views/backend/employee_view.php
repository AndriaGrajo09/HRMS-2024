                                ...
                                <a class="btn btn-circle btn-secondary" href="<?php if(!empty($socialmedia->google_Plus)) echo $socialmedia->google_Plus ?>" target="_blank"><i class="fa fa-google"></i></a>
				                                ...
				                                <form class="row" action="Update" method="post" enctype="multipart/form-data">
				                                    ...
				                                    <div class="form-group col-md-4 m-t-10">
				                                        ...
				                                        <input type="text" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control form-control-line" placeholder="ID" name="eid" value="<?php echo $basic->em_code; ?>" required > 
				                                    </div>
				                                    <div class="form-group col-md-4 m-t-10">
                                                    ...
                                                    <div class="form-group col-md-4 m-t-10">
                                                        ...
                                                        <select name="blood" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> value="<?php echo $basic->em_blood_group; ?>" class="form-control custom-select">
				                                    ...
				                                    <div class="form-group col-md-4 m-t-10">
				                                        <label>Gender </label>
				                                        <select name="gender" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control custom-select">
                                                   ...
                                                   <?php if($this->session->userdata('user_type')=='ADMIN'){ ?>  <?php } else { ?> 
                                                    <div class="form-group col-md-4 m-t-10">
                                                    ...
                                                    <div class="form-group col-md-4 m-t-10">
                                                        <label>Status </label>
                                                        <select name="status" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control custom-select" required >
				                                    ...
				                                    <div class="form-group col-md-4 m-t-10">
				                                        ...
				                                        <input type="text" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control"placeholder="NID Number" name="nid" value="<?php echo $basic->em_nid; ?>" minlength="10" required> 
				                                    </div>
				                                    <div class="form-group col-md-4 m-t-10">
                                                   ...
                                                   <?php if($this->session->userdata('user_type')=='ADMIN'){ ?>  <?php } else { ?> 				                                    
				                                    <div class="form-group col-md-4 m-t-10">
				                                        ...
				                                        <select name="dept" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control custom-select">
                                            ...
                                            <?php endforeach; ?>
                                                   ...
                                                   <?php if($this->session->userdata('user_type')=='ADMIN'){ ?>  <?php } else { ?> 				                                    
				                                    <div class="form-group col-md-4 m-t-10">
				                                        ...
				                                        <select name="deg" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control custom-select">
                                            ...
                                            <?php endforeach; ?>
				                                    ...
				                                    <div class="form-group col-md-4 m-t-10">
				                                        ...
				                                        <input type="date" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> id="example-email2" name="joindate" class="form-control" value="<?php echo $basic->em_joining_date; ?>" placeholder=""> 
				                                    </div>
				                                    <div class="form-group col-md-4 m-t-10">
                                   ...
                                   <?php if(!empty($basic->em_image)){ ?>
                                    ...
                                    <?php } ?>
                                                        <label>Image </label>
                                                        <input type="file" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> name="image_url" class="form-control" value=""> 
                                                    </div>
	                                    ...
	                                    <div class="card-body">
			                                <form class="row" action="Add_Education" method="post" enctype="multipart/form-data" id="insert_education">
			                                    ...
			                                    <div class="form-group col-md-6 m-t-5">
			                                        ...
			                                        <input type="text" name="year" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control form-control-line" placeholder="Passing Year"> 
			                                    </div>
			                                  <?php if($this->session->userdata('user_type')=='ADMIN'){ ?>
                                                    <?php } else { ?>
                                    ...
                                    <div class="card-body">
                                        <form class="row" action="Add_File" method="post" enctype="multipart/form-data">
                                            <div class="form-group col-md-6 m-t-5">
                                                ...
                                                <input type="text" name="title" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control" required="" aria-invalid="false" minlength="5" required>
                                            </div>
                                            <div class="form-group col-md-6 m-t-5">
                                                <label class="">File</label>
                                                <input type="file" name="file_url" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control" required="" aria-invalid="false" required>
                                            </div>
                                            <?php if($this->session->userdata('user_type')=='ADMIN'){ ?>
                                                    <?php } else { ?>
			                            ...
			                            <div class="card-body">
                                            ...
                                            <form action="Assign_leave" method="post" enctype="multipart/form-data">
                                                ...
                                                <label class="">Leave Type</label>                                 
                                                 <select name="typeid" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="select2 form-control custom-select" style="width: 100%" id="" required>
			                                 ...
			                                 <div class="form-group">
			                                    	<label>Day</label>
			                                    	<input type="number" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> name="noday" class="form-control form-control-line noday" placeholder="Leave Day" required> 
			                                 </div>
                                    ...
                                    <div class="card-body">
				                                <form class="row" action="Save_Social" method="post" enctype="multipart/form-data">
				                                    <div class="form-group col-md-6 m-t-20">
				                                        ...
				                                        <input type="url" class="form-control" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> name="facebook" value="<?php if(!empty($socialmedia->facebook)) echo $socialmedia->facebook ?>" placeholder="www.facebook.com"> 
				                                    </div>
				                                    <div class="form-group col-md-6 m-t-20">
				                                        <label>Twitter</label>
				                                        <input type="text" class="form-control" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> name="twitter" value="<?php if(!empty($socialmedia->twitter)) echo $socialmedia->twitter ?>" > 
				                                    </div>
				                                    <div class="form-group col-md-6 m-t-20">
				                                        <label>Google +</label>
				                                        <input type="text" id="" name="google" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control " value="<?php if(!empty($socialmedia->google_plus)) echo $socialmedia->google_plus ?>"> 
				                                    </div>
				                                    <div class="form-group col-md-6 m-t-20">
				                                        <label>Skype</label>
				                                        <input type="text" id="" name="skype" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control " value="<?php if(!empty($socialmedia->skype_id)) echo $socialmedia->skype_id ?>"> 
				                                    </div>
				                                <?php if($this->session->userdata('user_type')=='ADMIN'){ ?>
                                                    <?php } else { ?>
				                                    <div class="form-actions col-md-12">
				                        ...
				                        <div class="card-body">
                                           ...
                                           <div class="row">
                                            <div class="form-group col-md-6 m-t-5">
                                                ...
                                                <select class="form-control <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> custom-select" data-placeholder="Choose a Category" tabindex="1" name="typeid" required>
			                                    ...
			                                    <div class="form-group col-md-6 m-t-5">
			                                        ...
			                                        <input type="text" name="total" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control form-control-line total" placeholder="Total Salary" value="<?php if(!empty($salaryvalue->total)) echo $salaryvalue->total ?>" minlength="3" required> 
			                                    </div>
                                                </div>
			                                    ...
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label>Basic</label>
			                                        <input type="text" name="basic" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control form-control-line basic" placeholder="Basic..." value="<?php if(!empty($salaryvalue->basic)) echo $salaryvalue->basic ?>" > 
			                                    </div> 
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label>House Rent</label>
			                                        <input type="text" name="houserent" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control form-control-line houserent" placeholder="House Rent..." value="<?php if(!empty($salaryvalue->house_rent)) echo $salaryvalue->house_rent ?>" > 
			                                    </div> 
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label>Medical</label>
			                                        <input type="text" name="medical" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control form-control-line medical" placeholder="Medical..." value="<?php if(!empty($salaryvalue->medical)) echo $salaryvalue->medical ?>" > 
			                                    </div> 
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label>Conveyance</label>
			                                        <input type="text" name="conveyance" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control form-control-line conveyance" placeholder="Conveyance..." value="<?php if(!empty($salaryvalue->conveyance)) echo $salaryvalue->conveyance ?>" > 
			                                    </div>
                                                </div>
			                                    ...
			                                    <div class="form-group col-md-6 m-t-5">
			                                        ...
			                                        <input type="text" name="bima" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control form-control-line" placeholder="Insurance" value="<?php if(!empty($salaryvalue->bima)) echo $salaryvalue->bima ?>"> 
			                                    </div>
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label>Tax</label>
			                                        <input type="text" name="tax" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control form-control-line" placeholder="Tax" value="<?php if(!empty($salaryvalue->tax)) echo $salaryvalue->tax ?>" > 
			                                    </div>
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label>Provident Fund</label>
			                                        <input type="text" name="provident" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control form-control-line" placeholder="Provident..." value="<?php if(!empty($salaryvalue->provident_fund)) echo $salaryvalue->provident_fund ?>"> 
			                                    </div>
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label>Others</label>
			                                        <input type="text" name="others" <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> readonly <?php } ?> class="form-control form-control-line" placeholder="others..." value="<?php if(!empty($salaryvalue->others)) echo $salaryvalue->others ?>"> 
			                                    </div>
                                                </div>
                                                <?php if($this->session->userdata('user_type')=='ADMIN'){ ?>
                                                    <?php } else { ?>
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    ...
                                                    <?php } ?>                                                   
                                                    <button <?php if($this->session->userdata('user_type')=='ADMIN'){ ?> disabled <?php } ?> type="submit" style="float: right" class="btn btn-success">Add Salary</button>
                                                </div>
                                                <?php } ?>
                                            </div>                                                		                                    
			                                    </form>
