            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    ...
                    <div class="profile-text">
                        ...
                        <a onclick="return confirm('Are you sure you want to log-out?')" href="<?php echo base_url(); ?>login/logout" class="" data-toggle="tooltip" title="Logout"><i class="mdi mdi-power"></i></a>
                    </div>
                </div>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="<?php echo base_url(); ?>employee/view?I=<?php echo base64_encode($basicinfo->em_id); ?>" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Profile</span></a>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-rocket"></i><span class="hide-menu">Requests</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url(); ?>leave/EmApplication"> Leave </a></li>
                                <li><a href="<?php echo base_url(); ?>resignation/EmApplication"> Resignation</a></li>
                                <li><a href="<?php echo base_url(); ?>resignation/PromotionApplication"> Promotion </a></li>
                                <li><a href="<?php echo base_url(); ?>resignation/SALNApplication">SALN</a></li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-currency-usd"></i><span class="hide-menu">Payroll </span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-note"></i><span class="hide-menu">Resignations </span></a>
                            <ul aria-expanded="false" class="collapse">
                                <!--<li><a href="<?php #echo base_url(); ?>Payroll/Salary_Type"> Payroll Type </a></li>-->
                                <li><a href="<?php echo base_url(); ?>resignation/Application"> List </a></li>
                                <!-- <li><a href="<?php #echo base_url(); ?>Payroll/Generate_salary"> Generate Payslip</a></li>
                                <li><a href="<?php #echo base_url(); ?>Payroll/Payslip_Report"> Payslip Report</a></li> -->
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-grid"></i><span class="hide-menu">SALN Report</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <!-- <li><a href="<?php# echo base_url(); ?>Logistice/Assets_Category"> Assets Category </a></li> -->
                                <li><a href="<?php echo base_url(); ?>resignation/SALNApplication"> Asset List </a></li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-off"></i><span class="hide-menu">Promotion </span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url(); ?>resignation/PromotionApplication"> Promotion Application </a></li>
