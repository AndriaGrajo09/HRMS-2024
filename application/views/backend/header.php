    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo base_url(); ?>"><b>
                        <img src="<?php echo base_url();?>assets/images/20.png" alt="DRI" class="DRI-logo" style="width:73px; margin-top:30px;"/>
                        </b>
                        <!-- Logo text --><span>
                        <img src="<?php echo base_url();?>assets/images/100.png" alt="DRI" class="DRI-logo" style="width:130px; margin-top:30px;"/>
                         <!-- Light Logo text -->    
                         </span> </a>
                </div>
                    ...
                    <ul class="navbar-nav my-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                ...
                                <li> <a onclick="return confirm('Are you sure you want to log-out?')" href="<?php echo base_url(); ?>login/logout" class="" data-toggle="tooltip" title="Logout"><i class="mdi mdi-power"></i> Log-out</a></li>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#confirmLogoutButton").on('click', function (e) {
                    e.preventDefault();
