                                        ...
                                        <h3 class="m-b-0"> 
                                         <?php 
                                              //  $this->db->where('pro_status','running');
                                                $this->db->from("emp_resignation");
                                                echo $this->db->count_all_results();
                                            ?> Resignation
                                        </h3>
                                        <a href="<?php echo base_url(); ?>resignation/Application" class="text-muted m-b-0">View Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <h3 class="m-b-0">
                                         <?php 
                                               // $this->db->where('status','Granted');
                                                $this->db->from("emp_saln");
                                                echo $this->db->count_all_results();
                                            ?> SALN
                                        </h3>
                                        <a href="<?php echo base_url(); ?>resignation/SALNApplication" class="text-muted m-b-0">View Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-inverse card-danger">
                            <div class="box text-center">
                                <h1 class="font-light text-white">
                                     <?php 
                                            $this->db->where('resignation_status','Not Approved');
                                            $this->db->from("emp_resignation");
                                            echo $this->db->count_all_results();
                                        ?> 
                                </h1>
                                <h6 class="text-white">Pending Resignation Application</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                   <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-inverse card-success">
                            <div class="box text-center">
                                ...
                                <h6 class="text-white">SALN Submission</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
