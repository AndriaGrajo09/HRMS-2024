...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-fax" style="color:#1976d2"> </i> Resignation Report</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Resignation Report</li>
            </ol>
        </div>
    </div>
        ...
        <script>
            $(document).ready(function() {
                $("#BtnSubmit").on("click", function(event) {
                    ...
                    $.ajax({
                        url: "Get_ResignationDetails?date_time=" + datetime + "&emp_id=" + emid,
                        type: "GET",
                        data: 'data',
                        success: function(response) {
                            $('.resignation').html(response);
                        }
                    });
                });
            });
